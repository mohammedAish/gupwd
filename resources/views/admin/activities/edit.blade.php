            ...
            <div class="container p-5">
                <form action="{{ route('activities.update', $activity->id) }}" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group ">
                                ...
                                <div class="">
                                    <input type="text" value="{{ old('name_en', $activity->name_en) }}" name="name_en"
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group ">
                                ...
                                <div class="col-md- col-sm-12">
                                    <input type="text" value="{{ old('name_ar', $activity->name_ar) }}" name="name_ar"
                            ...
                            <div class="form-group ">
                                ...
                                <div class="">
                                    <textarea name="description_en" class="form-control md-input" data-provide="markdown"
                                        rows="10" style="resize: none;">{!! old('description_en', $activity->description_en) !!}</textarea>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-md- col-sm-12">
                                    <textarea name="description_ar" class="form-control md-input" data-provide="markdown"
                                        rows="10" style="resize: none;">{!! old('description_ar', $activity->description_ar) !!}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group ">
                                <label class=" col-form-label ">التاريخ<span
                                        style="color:#FF0000">*</span></label>
                                <div class="">
                                    <input type="date" value="{{ old('date', $activity->date) }}" name="date" id="date"
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group ">
                                <label class=" col-form-label ">النوع<span
                                        style="color:#FF0000">*</span></label>
                                <div class="">
                                <select name="type" class="form-select" aria-label="Default select example">
  <option value="{{ $activity->type}}"  selected>{{ old('type', $activity->type) }}</option>
  <option value="activity">أخبار و أنشطة</option>
                    ...
                    <div class="row">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="px-4 pt-5">
                                <img src="{{ asset('assets/images//' . $activity->image) }} "
