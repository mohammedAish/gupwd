                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group ">
                                ...
                                <div class="">
                                    <input type="text" value="{{ old('name_en', $project->name_en) }}" name="name_en"
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group ">
                                ...
                                <div class="col-md- col-sm-12">
                                    <input type="text" value="{{ old('name_ar', $project->name_ar) }}" name="name_ar"
                            ...
                            <div class="form-group ">
                                ...
                                <div class="">
                                    <textarea name="description_en" class="form-control md-input" data-provide="markdown"
                                        rows="10" style="resize: none;">{!! old('description_en', $project->description_en) !!}</textarea>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-md- col-sm-12">
                                    <textarea name="description_ar" class="form-control md-input" data-provide="markdown"
                                        rows="10" style="resize: none;">{!! old('description_ar', $project->description_ar) !!}</textarea>
