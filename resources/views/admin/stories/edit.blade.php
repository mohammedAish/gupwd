<x-admin-layout>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group ">
                                ...
                                <div class="">
                                    <input type="text" value="{{ old('name_en', $story->name_en) }}" name="name_en"
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group ">
                                ...
                                <div class="col-md- col-sm-12">
                                    <input type="text" value="{{ old('name_ar', $story->name_ar) }}" name="name_ar"
                            ...
                            <div class="form-group ">
                                ...
                                <div class="">
                                    <textarea name="description_en" class="form-control md-input" data-provide="markdown"
                                        rows="10" style="resize: none;">{!! old('description_en', $story->description_en) !!}</textarea>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-md- col-sm-12">
                                    <textarea name="description_ar" class="form-control md-input" data-provide="markdown"
                                        rows="10" style="resize: none;">{!! old('description_ar', $story->description_ar) !!}</textarea>
                    ...
                    <div class="row">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="px-4 pt-5">
                                <img src="{{ asset('assets/images//' . $story->image) }} "
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group ">
                                    <label class=" col-form-label ">فيديو <span
                                            style="color:#FF0000">*</span></label>
                                    <div class="col-md- col-sm-12 file-loading">
                                        <input id="input-freqd-2" name="video"
                                            value="{{ old('video', $story->video) }}"
    ...
    <source src="{{ asset('assets/images//' . $story->video) }} " type="video/mp4">
</video>
                                </div>
                            </div>
